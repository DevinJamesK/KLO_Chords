...
def build_ui():
    ...
    _font_px = int(14 * _DISPLAY_SCALE)
    # DejaVu Sans renders ~15% larger than Noto Sans at the same px; compensate.
    # draw_text sizes go up to 24px; bake the draw font at ≥24px to avoid upscaling.
    # On Mac _font_px=28 already exceeds 24, so reuse it; on Windows bake separately.
    _draw_px = max(_font_px, 21)
